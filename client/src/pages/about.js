...
const facts = [
  { icon: '📍', label: 'Location',  value: 'Warangal, Telangana' },
  { icon: '🎓', label: 'Education', value: 'B.Tech IT — BRECW (90%)' },
  { icon: '📅', label: 'Born',      value: '09 April 2005' },
  { icon: '🗣️', label: 'Languages', value: 'Telugu, English' },
  { icon: '📧', label: 'Email',     value: 'dommetilaxmiprasanna@gmail.com' },
  { icon: '📞', label: 'Phone',     value: '9989003356' },
];
        ...
        <div className="ab-content">
          ...
          <div className="ab-hero">
            <div>
              ...
              <h1 className="ab-name">D. LAXMI<br /><span>PRASANNA</span></h1>
              <p className="ab-tagline">
                Passionate about building real-world web applications — from clean UIs to robust backends.
                Currently pursuing B.Tech IT at BRECW with 90% till 5th Semester.
              </p>
            </div>
            <div>
              <div className="ab-badge">
                <div className="ab-badge-num">90%</div>
          ...
          <div className="ab-two">
            <div>
              ...
              <p className="ab-bio-text">
                Hi! I'm <b>Laxmi Prasanna</b>, a developer who loves turning ideas into
                real, working web applications. I'm currently learning and growing in
                <b> React, Node.js, and MongoDB</b>, and I'm always excited to take on
                new challenges and build things that matter.<br /><br />
                I'm open to <b>internships and freelance</b> opportunities where I can
                contribute, learn, and grow alongside a great team.
              </p>
            </div>
