        ...
        <div className="con-grid">
          <div>
            ...
            <div className="con-links">
              {[
                { icon: '✉', label: 'laxmi@email.com', href: 'mailto:laxmi@email.com' },
                { icon: '⌂', label: 'github.com/laxmi', href: 'https://github.com' },
                { icon: 'in', label: 'linkedin.com/in/laxmi', href: 'https://www.linkedin.com/in/laxmi-prasanna-359047285' },
              ].map(l => (
